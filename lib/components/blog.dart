...
import 'package:myconsultant/components/color.dart';
import 'package:myconsultant/components/spacing.dart';
import 'package:myconsultant/components/text.dart';
import 'package:myconsultant/components/typography.dart';
import 'package:myconsultant/pages/page_post.dart';
import 'package:myconsultant/pages/page_typography.dart';

import 'package:myconsultant/pages/page_contactus.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Align(
        ...
        child: TextBody(text: "My Consultant © 2023"),
      ),
    );
  }
}
                ...
                child: Container(
                  ...
                  child: Wrap(
                    children: <Widget>[
                      ...
                      TextButton(
                        onPressed: () =>
                        Navigator.pushNamed(context,ContactUs.name ),
                        style: menuButtonStyle,
                        child: const Text(
                          "Contact",
                        ),
